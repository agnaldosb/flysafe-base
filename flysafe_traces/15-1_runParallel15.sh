...
echo "Iniciando a execução paralela da etapa 14..."
...
WORKER_SCRIPT="15-2_parallelRoundsKeepAwarenessNodeAnalysis.sh"
...
echo "Processamento paralelo da etapa 14 concluído!"