...
/** 
 * @author Vinicius - MiM
 * @note Malicious UAV Implementation - Spoofed location data generation logic can be used in MiM
 * @date Jul 07, 2025  
*/
/**
...
/** 
 * @author Vinicius - MiM
 * @note Malicious UAV Implementation - Malicious node selection logic can be used in MiM
 * @date Jul 07, 2025  
*/
/**
