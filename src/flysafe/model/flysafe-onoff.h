...
#ifndef FLYSAFE_ONOFF_H
#define FLYSAFE_ONOFF_H
...
*/
class FlySafeOnOff : public Application 
{
public:
  /**
...
private:
  ...
  /**
   * @brief Notify neighbors nodes about node new position
   * 
   * @param position - coordinates (x,y,z)
   */
  void notifyNewPosition(Vector position);

  /**
   * @brief Imprime lista de vizinhos
   * 
   */
  ...
  /** 
   * @author Vinicius - MiM
   * @note Malicious UAV Implementation - Get malicious neighbor list from the node can be used in MiM
   * @date Jul 07, 2025  
  */
    /**
  ...
  /** 
   * @author Vinicius - MiM
   * @note Malicious UAV Implementation - Store the time a node becomes malicious and register wether a node becomes malicious can be used in MiM
   * @date Jul 07, 2025  
  */
  ...
  /** 
   * @author Vinicius - MiM
   * @note Malicious UAV Implementation - Malicious neighbors evolution can be used in MiM
   * @date Jul 07, 2025  
  */
