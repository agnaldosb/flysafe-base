...
//}
  ...
  /** 
   * @author Vinicius - MiM
   * @note Malicious UAV Implementation - Store the time a node becomes malicious can be used in MiM
   * @date Jul 07, 2025  
  */
  ...
  */
  ...
  /** 
   * @author Vinicius - MiM
   * @note Malicious UAV Implementation - Register wether a node becomes malicious can be used in MiM
   * @date Jul 07, 2025  
  */
